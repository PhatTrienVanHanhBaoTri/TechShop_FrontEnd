  ...
  useEffect(() => {
    switch (activeTab) {
      ...
      case "specs":
        ...
        setTabContent(
          <SpecsTab 
          specName1 = {product.specName1} spec1 = {product.spec1}
          specName2 = {product.specName2} spec2 = {product.spec2}
          specName3 = {product.specName3} spec3 = {product.spec3}
          specName4 = {product.specName4} spec4 = {product.spec4}
