...
return (
	<ul className="pl-md-3 navbar-nav m-auto mb-lg-0 d-flex justify-item-center align-items-center">
		...
		<li className="nav-item pt-md-3 m-3">
			<NavLink className="text-nowrap" activeClassName="active" to="/home" exact>
				Home
			</NavLink>
		</li>

		<li className="nav-item pt-md-3 m-3 dropdown-switcher">
			<NavLink className="text-nowrap" activeClassName="active" to="/products">
				Products
			</NavLink>
		...
		<li className="nav-item pt-md-3 m-3">
	        <NavLink className="text-nowrap" activeClassName="active" to="/wish-list">
	         	Wish List
	        </NavLink>
	    </li>

	    <li className="nav-item pt-md-3 m-3">
	        <NavLink className="text-nowrap" activeClassName="active" to="/contacts">
	          	Contacts
	        </NavLink>
	    </li>
	</ul>
